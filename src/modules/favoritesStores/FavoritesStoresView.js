...
import {favoritesStores} from '../../constants';

const favoriteIcon = (<MaterialIcon name='stars' size={26} color={colors.overlayBackground} />);
...
class FavoritesStoresView extends Component {
  static displayName = 'FavoritesStoresView';
  ...
  render() {
    const storesButtons = favoritesStores.map((store) => (
      <TouchableOpacity
        key={store.id}
...
export default FavoritesStoresView;
